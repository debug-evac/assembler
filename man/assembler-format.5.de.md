...
Diese Anweisungen werden verwendet, um arithmetische, logische und Verschiebeoperationen mit Registern durchzuführen:
...
: Logisches bitweises negiertes exklusives Oder des zweiten und dritten Registers. Beachten Sie, dass dies nicht in der RISC-V-Standarddefiniert ist.

equal register, register, register

: Vergleicht die zweiten und dritten Register und setzt das erste Register auf eins (1), wenn sie gleich sind. Beachten Sie, dass dies nicht in der RISC-V-Standarddefiniert ist.
...
Diese Anweisungen werden verwendet, um arithmetische, logische und Verschiebeoperationen mit unmittelbaren Werten durchzuführen:

Verschiebeoperationen können nur unmittelbare Werte von 4 Bits verwenden.

Beachten Sie, dass einige Anweisungen keine Labels verwenden können. Dies ist in Arbeit.

addi register, register, immediate|label

: Addition des zweiten Registers und des unmittelbaren oder Labels.

xori register, register, immediate

: Logisches bitweises exklusives Oder des zweiten Registers und des unmittelbaren.

ori register, register, immediate

: Logisches bitweises Oder des zweiten Registers und des unmittelbaren.
...
: Logische Linksverschiebung des zweiten Registers um das unmittelbare oder Label.

srli register, register, immediate|label

: Logische Rechtsverschiebung des zweiten Registers um das unmittelbare oder Label.

srai register, register, immediate|label

: Arithmetische Rechtsverschiebung des zweiten Registers um das unmittelbare oder Label.

slti register, register, immediate

: Das erste Register wird auf eins (1) gesetzt, wenn das zweite Register kleiner als das unmittelbare ist.

sltiu register, register, immediate

: Das erste Register wird auf eins (1) gesetzt, wenn das zweite Register kleiner als das unmittelbare ist. Der Inhalt der verglichenen Register wird als vorzeichenlose Zahlen interpretiert.
...
: Lädt ein Byte aus dem Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.

lh register, register, immediate|label

: Lädt eine Hälfte (16 Bit) aus dem Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.

lw register, register, immediate|label

: Lädt ein Wort (32 Bit) aus dem Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.

lbu register, register, immediate|label

: Lädt ein Byte aus dem Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist. Das Byte wird auf 32 Bits erweitert.

lhu register, register, immediate|label

: Lädt eine Hälfte aus dem Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist. Die Hälfte wird auf 32 Bits erweitert.

sb register, register, immediate|label

: Speichert ein Byte in den Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.

sh register, register, immediate|label

: Speichert eine Hälfte in den Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.

sw register, register, immediate|label

: Speichert ein Wort in den Speicher an der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist.
...
: Springen Sie, wenn die Register gleich sind.

bne register, register, immediate|label

: Springen Sie, wenn die Register nicht gleich sind.

blt register, register, immediate|label

: Springen Sie, wenn der Inhalt des ersten Registers kleiner ist als der Inhalt des letzten Registers. Der Inhalt der Register wird als vorzeichenbehaftete Zahlen interpretiert.

bltu register, register, immediate|label

: Springen Sie, wenn der Inhalt des ersten Registers kleiner ist als der Inhalt des letzten Registers. Der Inhalt der Register wird als vorzeichenlose Zahlen interpretiert.

bge register, register, immediate|label

: Springen Sie, wenn der Inhalt des ersten Registers größer oder gleich dem Inhalt des letzten Registers ist. Der Inhalt der Register wird als vorzeichenbehaftete Zahlen interpretiert.

bgeu register, register, immediate|label

: Springen Sie, wenn der Inhalt des ersten Registers größer oder gleich dem Inhalt des letzten Registers ist. Der Inhalt der Register wird als vorzeichenlose Zahlen interpretiert.

jal register, immediate|label

: Springen Sie und verknüpfen Sie mit der Adresse, die die Summe des Programmzählers und des unmittelbaren oder Labels ist. Die Rückkehradresse wird in das Register geschrieben.

jalr register, register, immediate|label

: Springen Sie und verknüpfen Sie mit der Adresse, die die Summe des zweiten Registers und des unmittelbaren oder Labels ist. Die Rückkehradresse wird in das Register geschrieben.

Diese Anweisungen können nicht kategorisiert werden:

lui register, immediate|label

: Laden Sie das obere unmittelbare. Die oberen 20 Bits des Registers werden auf das unmittelbare oder Labels gesetzt. Die unteren 12 Bits sind null.

auipc register, immediate|label

: Addieren Sie das obere unmittelbare auf den Programmzähler. Die oberen 20 Bits des unmittelbaren oder Labels werden zum Programmzähler addiert und das Ergebnis wird in das Register geschrieben.
